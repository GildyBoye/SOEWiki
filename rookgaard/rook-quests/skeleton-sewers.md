...
### Requisites <a href="#requisites" id="requisites"></a>

* **THIS QUEST REQUIRES 2 PLAYERS TO COMPLETE!!**
...
### Throwing stone <a href="#throwing_stone" id="throwing_stone"></a>

To continue the quest, the stone you have been either pushing or carrying needs to be drop on the water, on the floor switch with the red circle in the following image.

If you do it properly, you will see that the wall to the east will be removed (green circle).

<figure><img src="../../.gitbook/assets/image (88).png" alt=""><figcaption></figcaption></figure>

### Quest door <a href="#quest_door" id="quest_door"></a>
...
From now on, you will be able to open that door and access the skeleton archer area without doing the _stone mechanic_ anymore.
