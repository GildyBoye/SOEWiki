...
### Custom Spawns Location Guide on Souls of Elysium <a href="#custom_spawns_location_guide_on_souls_of_elysium" id="custom_spawns_location_guide_on_souls_of_elysium"></a>

**Souls of Elysium** contains dozens of custom spawns, introducing custom creatures, and familiar ones in a new environment!

* Not all spawns are made equally, some are harder to get to or contain more variety.
* Some Custom Monsters can be quite dangerous, so be careful!
* _Note: Entrance will be marked by cross-hair._
...
#### Abominations (elevator access needed) <a href="#abominations_elevator_access_needed" id="abominations_elevator_access_needed"></a>
...
#### Vicious Squires/Vile Grandmasters <a href="#vicious_squires_vile_grandmasters" id="vicious_squires_vile_grandmasters"></a>
...
### Mini Yalahar <a href="#mini_yalahar" id="mini_yalahar"></a>
...
#### Mutated Humans <a href="#mutated_humans" id="mutated_humans"></a>
...
#### Upper Mutated Rats <a href="#upper_mutated_rats" id="upper_mutated_rats"></a>

East in the Mutated Humans spawn, one floor up.
...
#### Lower Mutated Rats <a href="#lower_mutated_rats" id="lower_mutated_rats"></a>

West in the Mutated Humans spawn, one floor down. Requires having killed the Mutated Rat Task Boss once.
...
#### Mutated Tigers <a href="#mutated_tigers" id="mutated_tigers"></a>

South in the Lower Mutated Rats spawn, one floor down.
...
#### Grim Reapers <a href="#grim_reapers" id="grim_reapers"></a>

North in the Lower Mutated Rats spawn, one floor down.
...
### Goroma <a href="#goroma" id="goroma"></a>
...
#### Bonebeasts <a href="#bonebeasts" id="bonebeasts"></a>

**Creatures:** Bonebeasts, Crypt Shamblers, Demon Skeletons and two Water Elementals.
...
#### Quaras <a href="#quaras" id="quaras"></a>

**Creatures:** Quaras.

***

#### Serpent Spawn / Medusa <a href="#serpent_spawn_medusa" id="serpent_spawn_medusa"></a>
...
### Draken Island <a href="#draken_island" id="draken_island"></a>

Accessible from Port Hope, South of Chor. Find Drox in the harbor and ask for passage.

***

#### Souleaters <a href="#souleaters" id="souleaters"></a>

The entire northern part of the island is filled with Souleaters. Both on the ground level and up the mountain.
...
#### Draken Tower <a href="#draken_tower" id="draken_tower"></a>

East of the island, fairly close to the boat.
...
#### Lizard Chosen <a href="#lizard_chosen" id="lizard_chosen"></a>
...
#### Ghastly Dragons <a href="#ghastly_dragons" id="ghastly_dragons"></a>
